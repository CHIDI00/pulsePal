...
import { IoBarChartOutline, IoHomeOutline, IoSettingsOutline } from "react-icons/io5";
    ...
    <sidebar className="fixed top-0 bottom-0 left-0 right-0 h-screen bg-gray-50 !px-3 z-10 shadow-xl w-fit section">
      <div className="flex flex-col justify-between h-full px-16 space-y-20 w-fit">
        ...
        <nav className="flex flex-col w-full">
          <h4 className="mb-3 text-4xl font-semibold text-gray-600 uppercase">menu</h4>
          <ul className="flex flex-col gap-1">
            ...
            <li className="flex items-center px-4 py-6 text-3xl font-medium cursor-pointer hover:font-bold gap-7 hover:bg-gray-200 hover:scale-95 rounded-xl">
              <IoBarChartOutline className="text-4xl" /> wellness history
            </li>
            <li className="flex items-center px-4 py-6 text-3xl font-medium cursor-pointer hover:font-bold gap-7 hover:bg-gray-200 hover:scale-95 rounded-xl">
        ...
        <div className="flex flex-col items-center gap-10 py-6 px-7 bg-gradient-to-r from-purple-300 to-pink-300 float-end rounded-xl">
          <h3 className="text-3xl font-semibold text-gray-600">daily wellness goal</h3>
